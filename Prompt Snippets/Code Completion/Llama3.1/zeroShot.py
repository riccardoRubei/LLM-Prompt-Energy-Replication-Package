...
def tempFun(model,tokenizer):
    ...
    {
        "role": "user",
        "content": "public statid void main("
    }
    ]
    system_conf1 = zero_shot_message[0]['content']
    message_conf1 = zero_shot_message[-1]['content']
